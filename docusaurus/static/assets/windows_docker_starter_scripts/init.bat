...
docker run -itd --name ai-server -p %ACTIVE_PORT%:8080 docker.cfg.deloitte.com/genai/genai-server:latest
docker cp semoss_init.sh ai-server:/opt/semosshome
docker exec -itd ai-server bash -c %SEMOSS_BASH_INIT%
